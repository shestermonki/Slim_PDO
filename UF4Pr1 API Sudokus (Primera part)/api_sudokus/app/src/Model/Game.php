...
class Game
{
  ...
  public function getSudoku(): \ApiSudoku\Model\Sudoku
  {
    return $this->sudoku;
  }
  public function setSudoku(\Sudoku\Model\Sudoku $sudoku)
  {
    $this->sudoku = $sudoku;
  }
  public function getPlayer(): \ApiSudoku\Model\Player
  {
    return $this->player;
  }
  public function setPlayer(\Sudoku\Model\Player $player)
  {
    $this->player = $player;
  }
